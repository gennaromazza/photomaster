import { pgTable, text, serial, integer, boolean, timestamp, jsonb, foreignKey, numeric, date, time } from "drizzle-orm/pg-core";
import { createInsertSchema } from "drizzle-zod";
import { z } from "zod";
import { relations } from "drizzle-orm";

// Per garantire compatibilità
export const TABLE_ID_COLLABORATORI = "collaborators";
 ...
 * - Montaggi
 * 
 * Questo file è progettato per essere importato da schema.ts
 */

// Tabella per gli eventi dei collaboratori
...
// Tabella per i pagamenti dei collaboratori
...
// Schema per l'inserimento di un nuovo evento collaboratore
...
// Schema per l'inserimento di un nuovo pagamento
...
// Schema per l'inserimento di un nuovo montaggio
...
// Schema per l'aggiornamento di un montaggio esistente
